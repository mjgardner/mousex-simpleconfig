...
is based on the abstract role L<MouseX::ConfigFromFile|MouseX::ConfigFromFile>, and uses
L<Config::Any|Config::Any> to load your configfile.  L<Config::Any|Config::Any> will in
...
Like all L<MouseX::ConfigFromFile|MouseX::ConfigFromFile> -derived configfile loaders, this
module is automatically supported by the L<MouseX::Getopt|MouseX::Getopt> role as
...
Provided by the base role L<MouseX::ConfigFromFile|MouseX::ConfigFromFile>.  You can
...
Provided by the base role L<MouseX::ConfigFromFile|MouseX::ConfigFromFile>.  Acts just like
...
Called internally by either C<new_with_config> or L<MouseX::Getopt|MouseX::Getopt>'s
C<new_with_options>.  Invokes L<Config::Any|Config::Any> to parse C<configfile>.
